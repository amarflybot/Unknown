...
export class Config {
  ...
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'NhipsterSampleGraphql';
  ...
  'jhipster.mail.from' = 'NhipsterSampleGraphql@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'NhipsterSampleGraphql API';
  'jhipster.swagger.description' = 'NhipsterSampleGraphql API documentation';
  ...
  'eureka.instance.appname' = 'NhipsterSampleGraphql';
  'eureka.instance.instanceId' = 'NhipsterSampleGraphql:${random.value}';
  ...
  'cloud.config.name' = 'NhipsterSampleGraphql';
